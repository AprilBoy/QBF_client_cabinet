$(document).ready(function () {
    ...
    $('.settings__title--js').click(function () {
        var title = $(this).next();
        $('.settings__items--js').not(title).addClass('settings__items_hide');
    ...
    $('.settings_title_pickup--js').click(function () {
        var title = $(this).next();
        $('.payment__content').not(title).addClass('payment__content_hide');
        title.toggleClass('payment__content_hide');
        $('html, body').animate({
            scrollTop: title.offset().top - 200
        }, 500);
    });
